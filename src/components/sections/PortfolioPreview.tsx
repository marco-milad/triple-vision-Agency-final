...
const portfolioItems = [
  { title: 'Brand Film Production', category: 'Media Production', client: 'Premium Tech Co.', image: 'https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=800&q=80', color: 'from-orange-500/20 to-red-500/20', gradient: 'from-orange-500 to-red-500', type: 'video' },
  { title: 'Tech Summit 2024', category: 'Event Coverage', client: 'TechCorp', image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80', color: 'from-purple-500/20 to-pink-500/20', gradient: 'from-purple-500 to-pink-500', type: 'image' },
  { title: 'Luxe Brand Identity', category: 'Branding', client: 'Luxury Brand', image: 'https://images.unsplash.com/photo-1558655146-9f40138edfeb?w=800&q=80', color: 'from-blue-500/20 to-cyan-500/20', gradient: 'from-blue-500 to-cyan-500', type: 'image' },
  { title: 'E-Commerce Platform', category: 'Web Development', client: 'Retail Giant', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80', color: 'from-green-500/20 to-emerald-500/20', gradient: 'from-green-500 to-emerald-500', type: 'web' },
];
            ...
            >
              <Link to="/portfolio" className="block group">
                ...
                >
                  ...
                  <motion.div className={`absolute inset-0 bg-gradient-to-br ${item.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
                  ...
                  <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-end z-10">
                    ...
                    >
                      <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/20 backdrop-blur-sm border border-primary/30 mb-3">
                        <span className="text-primary text-xs md:text-sm font-semibold">{item.category}</span>
                      </div>
                      <h3 className="text-xl md:text-2xl lg:text-3xl font-black text-white mb-2 group-hover:text-primary transition-colors drop-shadow-lg">{item.title}</h3>
                      <p className="text-white/80 text-sm md:text-base mb-4 font-medium">Client: {item.client}</p>
                  ...
                  <motion.div className={`absolute bottom-0 left-0 right-0 h-1.5 bg-gradient-to-r ${item.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300`} />
                </motion.div>
              </Link>
            </motion.div>
          ))}
