  ...
  return (
    <section className="section-padding bg-gradient-to-br from-background via-background to-background-secondary relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] rounded-full bg-primary/10 blur-[80px]" />
        <div className="absolute bottom-0 right-0 w-[600px] h-[600px] rounded-full bg-purple-500/5 blur-[60px]" />
        <div className="absolute top-1/3 left-0 w-[500px] h-[500px] rounded-full bg-orange-500/5 blur-[60px]" />
      </div>
      ...
      <div className="absolute top-1/4 right-10 w-20 h-20 rounded-2xl bg-gradient-to-br from-primary/10 to-purple-500/10 border border-primary/20 hidden lg:block" />
      <div className="absolute bottom-1/4 left-10 w-16 h-16 rounded-xl bg-gradient-to-br from-orange-500/10 to-pink-500/10 border border-primary/20 hidden lg:block" />
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-foreground mb-6 leading-[1.1]">
            ...
            <span className="bg-gradient-to-r from-primary via-orange-500 to-pink-500 bg-clip-text text-transparent">Bold Brands</span>
          </h2>
          ...
          {services.map((service, index) => (
            ...
            >
              <Link to={service.path} className="block group h-full">
                ...
                >
                  <motion.div className="absolute inset-0 bg-gradient-to-br from-primary/0 to-primary/0 group-hover:from-primary/10 group-hover:to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  <motion.div className={`absolute inset-0 bg-gradient-to-br ${service.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500`} />
                  ...
                  <div className="relative mb-6">
                    ...
                    <motion.div className={`absolute -inset-2 rounded-2xl bg-gradient-to-br ${service.color} opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500`} />
                  </div>
                  ...
                  <motion.div className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${service.color} opacity-0 group-hover:opacity-100 transition-opacity duration-300`} />
                </motion.div>
              </Link>
            </motion.div>
          ))}
